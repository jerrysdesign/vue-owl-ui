...
if ("build" === 'build' && _isEnv.isBrowser) {
  ...
  style.textContent = __webpack_require__(32);
...
var _dualList = __webpack_require__(20);
...
Dual.Group = {
  ...
  methods: {
    ...
    handleSearchListLeft: function handleSearchListLeft(e) {
      ...
      if (e.charCode === 13) {
        var keys = Object.keys(this.leftList).filter(function (key) {
          return _this3.leftList[key].includes(_this3.$refs.searchListToAdd.value);
        });
        this.listToAdd = keys.reduce(function (preVal, curVal) {
          return Object.assign(preVal, _defineProperty({}, curVal, _this3.leftList[curVal]));
        }, {});
    ...
    handleSearchListRight: function handleSearchListRight(e) {
      ...
      if (e.charCode === 13) {
        var keys = Object.keys(this.rightList).filter(function (key) {
          return _this4.rightList[key].includes(_this4.$refs.searchListToRemove.value);
        });
        this.listToRemove = keys.reduce(function (preVal, curVal) {
          return Object.assign(preVal, _defineProperty({}, curVal, _this4.rightList[curVal]));
        }, {});
      ...
      [h(
        ...
        [h(
          ...
          [h(
            _input2.default,
            {
              attrs: { name: 'left', icon: ['search', '#919799'], x: true },
          ...
          [Object.keys(this.listToAdd).map(function (label) {
            return h(
              Dual.List,
              {
                attrs: { id: label, name: _this5.listToAdd[label], highlight: highlightLeft, icon: ['circle-add', '#b9e617'] }
              },
              []
            );
          })]
        ...
        [h(
          ...
          [Object.keys(this.listToRemove).map(function (label) {
            return h(
              Dual.List,
              {
                attrs: { id: label, name: _this5.listToRemove[label], highlight: highlightRight, icon: ['circle-minus', '#e6175c'] }
              },
              []
            );
          })]
...
Dual.List = {
  ...
  computed: {
    highlightText: function highlightText() {
      ...
      var highlightText = '';
      if (highlight) {
        var highlightReg = new RegExp('' + highlight, 'g');
        highlightText = ('<span>' + name + '</span>').replace(highlightReg, '<span class="' + _dualList2.default.highlight + '">' + highlight + '</span>');
      }
...
var Page = {
  ...
  computed: {
    ...
    pageLists: function pageLists() {
      ...
      var start = page - pageData.mid;
      var end = page + pageData.mid;
...
var _switch = __webpack_require__(28);
