...
if ("build" === 'build' && _isEnv.isBrowser) {
  ...
  style.textContent = __webpack_require__(33);

  document.head.appendChild(style);
}

// exports by automation
module.exports = { "Button": __webpack_require__(7), "Checkbox": __webpack_require__(8), "DualList": __webpack_require__(9), "Grid": __webpack_require__(10), "Icon": __webpack_require__(0), "Input": __webpack_require__(2), "Label": __webpack_require__(11), "LightBox": __webpack_require__(12), "Loading": __webpack_require__(4), "Page": __webpack_require__(13), "Radio": __webpack_require__(14), "Select": __webpack_require__(15), "Switch": __webpack_require__(16), "Tab": __webpack_require__(17), "Tip": __webpack_require__(18) };
...
var _dualList = __webpack_require__(21);
...
var DualList = {
  ...
  watch: {
    items: function items() {
      this.leftList = this.listToAdd = this.items.reduce(function (preVal, curVal, idx) {
        return _extends({}, preVal, _defineProperty({}, idx, curVal));
      }, {});
    }
  },
...
// removed by extract-text-webpack-plugin
module.exports = {"inputWrapper":"_1znPA","input":"_2y3V7","mustFill":"_2MB8F","normal":"_1qTPh","success":"_1kPIr","error":"_1w9VL","loadingPie":"_25SP3","icon":"_1UKWW"};
